...
if __name__=='__main__':
    ...
    #override config
    config = get_config()
    config['OUTPUT_PATH'] = './result_v1/03_01/'
    config['model_path'] = '../../02_train/result_v1/02/'
    config['model_name'] = 'seresnext101_v1'
    config['val_idxs_list_path'] = '../../02_train/result_v1/02/'
    ...
    print("pseudo_label_kaggle_data_03_01_v7_5.py")
    print(start)
